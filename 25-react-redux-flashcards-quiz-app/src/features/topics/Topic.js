...
export default function Topic() {
  ...
  const quizzesForTopic = topic.quizIds.map((quizId) => quizzes[quizId]); // maps all the quizzes from state that have a matching quizId to those ids included in the topic.quizIds array
